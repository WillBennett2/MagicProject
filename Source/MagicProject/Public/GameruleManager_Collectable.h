 ...
 */
UCLASS()
class MAGICPROJECT_API AGameruleManager_Collectable : public AGameruleManager
{
	GENERATED_BODY()
protected:
	...
	void Collected(ACollectable* delegateInstigator); // binding to collectables when collected
